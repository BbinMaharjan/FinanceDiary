...
export default function MonthlyBook() {
  ...
  const { startDate, endDate } = selectedMonth
    ? getMonthDateRange(selectedMonth, year)
    : { startDate: "", endDate: "" };
  ...
  const currentSummary = summaries.find(
    (s: MonthlySummary) => s.month === selectedMonth,
  );
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      {isLoading ? (
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <Skeleton.Button
            active
            style={{ height: 128, borderRadius: 12, width: "100%" }}
          />
          <Skeleton.Button
            active
            style={{ height: 192, borderRadius: 12, width: "100%" }}
          />
        </div>
      ) : currentSummary ? (
        <>
              ...
              <Flex justify="space-around" style={{ padding: "12px 0" }}>
                {[
                  ...
                  },
                  {
                    ...
                    color: currentSummary.balance >= 0 ? "#22c55e" : "#ef4444",
                  },
                ].map((card) => (
      ...
      {summaries.length > 0 && (
        <Card
          title={
            <Typography.Text strong>All Monthly Summaries</Typography.Text>
          }
